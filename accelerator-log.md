...
```json
{
  "projectName" : "hellospring-tanzu-web",
  "buildTool" : "maven",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->hellospring-tanzu-we...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: hellospring-tanzu-...(truncated)]
